...
/*chart-area-spline-sracked*/
 ...
 /*chart-bar-stacked*/
  ...
  /*chart-donut*/
	var chart = c3.generate({
		...
		data: {
			columns: [
					// each columns data
					['data1', document.getElementById("rent").value],
					['data2', document.getElementById("power").value],
					['data3', document.getElementById("water").value],
					['data4',document.getElementById("pending").value]
				],
				type: 'donut', // default type of chart
				colors: {
					data1: '#52fb6a',
					data2: 'rgb(255, 115, 123)',
					data3: '#42cdff',
					data4: '#ffb800'
  ...
  /*chart-donut*/
    ...
    /*chart-donut*/
	var chart = c3.generate({
		bindto: '#chart-donut-year', // id of chart wrapper
		data: {
			columns: [
					// each columns data
					['data1', document.getElementById("rent1").value],
					['data2', document.getElementById("power1").value],
					['data3', document.getElementById("water1").value],
					['data4',document.getElementById("pending1").value]
				],
				type: 'donut', // default type of chart
				colors: {
					data1: '#52fb6a',
