...
$(document).ready(function () {
  ...
  if ($("#invoice_chart").length > 0) {
    var pieCtx = document.getElementById("invoice_chart"),
      pieConfig = {
        ...
        labels: ["Rent", "Power", "Water", "Pending"],
        legend: { show: false },
        responsive: [
          {
            breakpoint: 480,
      ...
      series: [
        {
          name: "Invoices",
          type: "column",
          data: invoiceData.map((item) => item.invoice_count),
        },
        {
          name: " Payments",
          type: "line",
          data: paymentData.map((item) => item.payment_count),
        },
      ],
      stroke: {
        width: [0, 4],
  ...
  if ($("#mixed-chart2").length > 0) {
    var options = {
      ...
      series: [
        {
          name: "Invoices",
          type: "column",
          data: invoiceDataYear.map((item) => item.invoice_count_year),
        },
        {
          name: " Payments",
          type: "line",
          data: paymentDataYear.map((item) => item.payment_count_year),
        },
      ],
      stroke: {
        width: [0, 4],
      ...
      labels: invoiceDataYear.filter(item => item.year).map(item => item.year),
    ...
    var chart = new ApexCharts(document.querySelector("#mixed-chart2"), options);
