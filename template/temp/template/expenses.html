										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>
													<td>1</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148061</a>
													</td>
													<td>#25689825</td>													
													<td>$1,54,220</td>													
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/expenses-01.jpg" alt="User Image">
														</h2>
													</td>
													<td>Cash</td>
												...
												<tr>
													<td>2</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148062</a>
													</td>
													<td>#25689826</td>													
													<td>$1,222</td>
													<td>
												...
												<tr>
													<td>3</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148063</a>
													</td>
													<td>#25689827</td>												
													<td>$2,2222</td>
													<td>
												...
												<tr>
													<td>4</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148064</a>
													</td>
													<td>#25689828</td>													
													<td>$5,222</td>
													<td>
												...
												<tr>
													<td>5</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148065</a>
													</td>
													<td>#25689829</td>													
													<td>$8,54,220</td>													
													<td>
												...
												<tr>
													<td>6</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148066</a>
													</td>
													<td>#25689830</td>													
													<td>$3,54,220</td>													
													<td>
												...
												<tr>
													<td>7</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148067</a>
													</td>
													<td>#25689831</td>													
													<td>$1,54,220</td>													
													<td>
												...
												<tr>
													<td>9</td>	
													<td>
														<a href="invoice-details.html" class="invoice-link">EXP-148068</a>
													</td>
													<td>#25689833</td>												
													<td>$2,2222</td>
													<td>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<div class="form-upload-label">
											<label>Attachment </label>
										</div>
										<div class="form-upload-file">
											<span><i class="fe fe-upload-cloud me-2"></i>Attach Files</span>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Expense ID</label>
										<input type="text" class="form-control" value="EXP-148061" placeholder="Enter Name">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Reference</label>
										<input type="text" class="form-control" value="25689825" placeholder="Enter Reference Number">
									</div>
								</div>								
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Amount</label>
										<input type="text" class="form-control" value="1,54,220" placeholder="Select Date">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Payment Mode</label>
										<input type="text" class="form-control" value="Cash" placeholder="Enter Payment Mode">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Expense Date</label>
										<input type="text" class="form-control" value="29 Jan 2022" placeholder="Enter Expense Date">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
								...
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Attachment</label>
										<input type="text" class="form-control" value="Attachment" placeholder="Enter Attachment Number">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group mb-0">
										<label>Notes</label>
										<input type="text" class="form-control" value="Notes" placeholder="Enter Notes Number">
									</div>
								</div>
							</div>
						</div>
