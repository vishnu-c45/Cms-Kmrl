								...
								<div class="col-lg-12">
									<div class="invoices-tabs">
										<ul>
											...
											<li><a href="tickets-list-draft.html" class="active">Draft</a></li>	
					...
					<div class="comments">
							...
							<div class="card-body card-support">
								<div class="comments-details d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center describe-btn mt-0">
										<h6 class="fw-bolder text-gray-dark">Support for theme</h6><span class="badge badge-pill bg-success-light ms-3">Draft</span>
									</div>
						...
						<div class="card">
							<div class="card-body card-support">
								<div class="comments-details d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center describe-btn mt-0">
										<h6 class="fw-bolder text-gray-dark">Verify your email</h6><span class="badge badge-pill bg-success-light ms-3">Draft</span>
									</div>
									<a href="#" class="reply-comment d-flex text-gray-light"><span><i class="fe fe-clock text-gray-light fw-normal me-2"></i></span><span class="text-gray-light fw-normal">Just Now</span></a>
								</div>
								<div class="card-describe">
						...
						<div class="card">
							<div class="card-body card-support">
								<div class="comments-details d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center describe-btn mt-0">
										<h6 class="fw-bolder text-gray-dark">Calling for help</h6><span class="badge badge-pill bg-success-light ms-3">Draft</span>
									</div>
									<a href="#" class="reply-comment d-flex text-gray-light"><span><i class="fe fe-clock text-gray-light fw-normal me-2"></i></span><span class="text-gray-light fw-normal">Just Now</span></a>
								</div>
								<div class="card-describe">
						...
						<div class="card">
							<div class="card-body card-support">
								<div class="comments-details d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center describe-btn mt-0">
										<h6 class="fw-bolder text-gray-dark">Management</h6><span class="badge badge-pill bg-success-light ms-3">Draft</span>
									</div>
									<a href="#" class="reply-comment d-flex text-gray-light"><span><i class="fe fe-clock text-gray-light fw-normal me-2"></i></span><span class="text-gray-light fw-normal">Just Now</span></a>
								</div>
								<div class="card-describe">
