											...
											<tbody>
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<a class=" btn-action-icon me-2" href="javascript:void(0);" download><i class="fe fe-eye"></i></a> 
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-07.jpg" alt="User Image"></a>
															<a href="profile.html">Johnny Smith <span>johnnysmith@example.com</span></a>
														</h2>
													</td>
													<td>#25689831</td>													
													<td>$1,54,220</td>													
