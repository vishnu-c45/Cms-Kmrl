				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a class="active" href="settings.html"><i class="fe fe-settings"></i> <span>Settings</span></a>
							</li>
							<li>
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a href="#" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Add Tax</a>
								</div>
							</div>
						</div>
					</div>
