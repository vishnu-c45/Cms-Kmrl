							...
							<div class="card-body">
								<div class="form-group-item border-0 pb-0">
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Slug <span class="optional"> (If you leave it empty, it will be generated automatically.)</span></label>
												<input type="text" class="form-control" placeholder="Enter Slug">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Description <span class="optional"> (Meta Tag)</span></label>
												<input type="text" class="form-control" placeholder="Enter Slug">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
