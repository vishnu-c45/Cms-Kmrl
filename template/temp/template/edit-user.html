				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								<a href="#" class="active"><i class="fe fe-user"></i> <span> Manage Users</span> <span class="menu-arrow"></span></a>
								<ul>
								...
								<div class="form-group-item">
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Role</label>
												<input type="text" class="form-control" value="Lorem ipsum" placeholder="Enter Phone Number" name="name">
											</div>
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="pass-group" id="passwordInput1">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="12345678" placeholder="">
												</div>
											</div>
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
										...
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Status</label>
												<input type="text" class="form-control" value="Active" placeholder="Status">
											</div>
										</div>
									</div>
								</div>						
