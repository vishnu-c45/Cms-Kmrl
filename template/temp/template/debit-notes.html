													...
													<td class="d-flex align-items-center">
														...
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<ul>
																	<li>
																		<a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-3"></i>Delete</a>
																	</li>
																</ul>
															</div>
														</div>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Robert <span>+1 917-409-0861</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Johnny<span>+1 956-623-2880</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Randall<span>+1 707-439-1732</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Russell Copeland<span>+1 559-741-9672</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Barbara Moore<span>+1 989-438-3131</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
