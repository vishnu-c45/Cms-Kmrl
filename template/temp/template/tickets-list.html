						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a class="active" href="tickets-list.html">Tickets List</a></li>
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn-filters" href="tickets-kanban.html"><span><i class="fe fe-grid"></i></span> </a>
									</li>
									<li>
										<a class="active btn-filters" href="tickets-list.html"><span><i class="fe fe-list"></i></span> </a>
									</li>
									<li>
							...
							<div class="row align-items-center">
								<div class="col-lg-12">
									<div class="invoices-tabs">
										<ul>
											<li><a href="tickets.html" class="active">All</a></li>
											<li><a href="tickets-pending.html">Pending</a></li>	
											<li><a href="tickets-overdue.html">Overdue</a></li>		
											<li><a href="tickets-draft.html">Draft</a></li>	
											<li><a href="tickets-recurring.html">Recurring</a></li>
											<li><a href="tickets-cancelled.html">Cancelled</a></li>
										</ul>
									</div>
								</div>
							</div>
										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<span class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-07.jpg" alt="User Image"></span>
															<span>Charles Hafner</span>
														</h2>
													</td>	
													<td>17 Dec 2022</td>
													<td>19 Dec 2022, 6:12PM</td>
													<td>16 Jan 2023</td>
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
															<a>John Smith <span>+1 843-443-3282</span></a>
														</h2>
													</td>
													<td>18 Jan 2023</td>	
													<td><span class="badge bg-warning-light text-warning-light">Medium</span></td>
														...
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<ul>
																	...
																	<li>
																		<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-bell-slash me-2"></i>Deactivate</a>
																	</li>
																</ul>
															</div>
														</div>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<span class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-02.jpg" alt="User Image"></span>
															<span>Michel</span>
														</h2>
													</td>	
													<td>21 Dec 2022</td>
													<td>23 Dec 2022, 6:12PM</td>
													<td>28 Feb 2023</td>
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-05.jpg" alt="User Image"></a>
															<a>John Smith <span>+1 843-443-4298</span></a>
														</h2>
													</td>
													<td>21 Jan 2023</td>	
													<td><span class="badge bg-primary-light">Low</span></td>
													<td><span class="badge bg-success-light text-success-light">Paid</span></td>
													<td class="d-flex align-items-center">
														<div class="dropdown dropdown-action">
															<a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<span class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-04.jpg" alt="User Image"></span>
															<span>Sharonda</span>
														</h2>
													</td>	
													<td>28 Jan 2022</td>
													<td>29 Jan 2022, 6:12PM</td>
													<td>28 Mar 2023</td>
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-06.jpg" alt="User Image"></a>
															<a>Pricilla  <span>+1 843-443-5298</span></a>
														</h2>
													</td>
													<td>21 Jan 2023</td>	
													<td><span class="badge bg-danger-light">High</span></td>
													<td><span class="badge bg-success-light text-success-light">Paid</span></td>
													<td class="d-flex align-items-center">
														<div class="dropdown dropdown-action">
															<a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<span class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-08.jpg" alt="User Image"></span>
															<span>Sharonda</span>
														</h2>
													</td>	
													<td>27 Feb 2022</td>
													<td>28 Feb 2022, 6:12PM</td>
													<td>29 Mar 2023</td>
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-09.jpg" alt="User Image"></a>
															<a>Randall  <span>+1 843-443-5298</span></a>
														</h2>
													</td>
													<td>25 Jan 2023</td>	
													<td><span class="badge bg-warning-light text-warning-light">Medium</span></td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<span class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-11.jpg" alt="User Image"></span>
															<span>Esther</span>
														</h2>
													</td>	
													<td>21 Dec 2022</td>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a>Charles Hafner <span>+1 843-443-4298</span></a>
														</h2>
													</td>
													<td>21 Jan 2023</td>	
													<td><span class="badge bg-primary-light">Low</span></td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<span class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-09.jpg" alt="User Image"></span>
															<span>Randall</span>
														</h2>
													</td>	
													<td>28 Jan 2022</td>
													<td>30 Jan 2022, 6:12PM</td>
													<td>29 Mar 2023</td>
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-04.jpg" alt="User Image"></a>
															<a>Sharonda  <span>+1 843-443-4987</span></a>
														</h2>
													</td>
													<td>21 Jan 2023</td>	
													<td><span class="badge bg-danger-light">High</span></td>
												...
												<tr>
													<td>
														<a href="invoice-details.html" class="invoice-link">#4993</a>
													</td>
													<td>verify your email</td>
													<td>
														<h2 class="table-avatar">
												...
												<tr>
													<td>
														<a href="invoice-details.html" class="invoice-link">#4994</a>
													</td>
													<td>Calling for help</td>
													<td>
														<h2 class="table-avatar">
								...
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										...
										<div class="cal-icon cal-icon-info">
											<input type="datetimepicker" class="datetimepicker form-control" placeholder="Select Date">
										</div>
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
