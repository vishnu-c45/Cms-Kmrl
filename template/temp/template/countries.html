					...
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									<li><a class="active" href="countries.html">Countries</a></li>
						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_countries"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Countries</a>
									</li>
								</ul>
							</div>
						</div>
										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/flags/as.png" alt="User Image">
														</h2>American Samoa(+684)
													</td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_countries"><i class="fe fe-edit"></i></a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/flags/ad.png" alt="User Image">
														</h2>Andorra (+376)
													</td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_countries"><i class="fe fe-edit"></i></a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/flags/ao.png" alt="User Image">
														</h2>Angola (+244)
													</td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_countries"><i class="fe fe-edit"></i></a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/flags/ai.png" alt="User Image">
														</h2>Anguilla (+1264)
													</td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_countries"><i class="fe fe-edit"></i></a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/flags/ag.png" alt="User Image">
														</h2>Antigua & Barbuda (+1268)
													</td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_countries"><i class="fe fe-edit"></i></a>
														<a class=" btn-action-icon" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="fe fe-trash-2"></i></a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/flags/au.png" alt="User Image">
														</h2>Australia
													</td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_countries"><i class="fe fe-edit"></i></a>
				...
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="#" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Add Countries</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Country Code</label>
										<input type="text" class="form-control" value="684" placeholder="Enter Country Code">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Country ID</label>
										<input type="text" class="form-control" value="AS" placeholder="Select Date">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group mb-0">
										<label>Country Name</label>
										<input type="text" class="form-control" value="American Samoa" placeholder="Enter Reference Number">
									</div>
								</div>
							</div>
						</div>
