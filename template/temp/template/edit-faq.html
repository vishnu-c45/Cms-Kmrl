			...
			<div class="page-wrapper">
				<div class="content container-fluid">
					<div class="content-page-header">
						<h5 class="text-center m-auto">Edit FAQ</h5>
					</div>					
					<div class="row">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												...
												<input type="text"  class="form-control" value="Duis aute irure in reprehenderit in voluptate velit" placeholder="Enter Title">
											</div>											
										</div>
										<div class="col-lg-12">
											<div class="form-group">
												<label>Category</label>
												<input type="text" class="form-control" value="19 Dec 2022, 06:12 PM" placeholder="Enter Category">
											</div>											
										</div>
										<div class="col-lg-12">
											<div class="form-group">
												<label>Details</label>
												<input type="text" class="form-control" value="Ut enim ad minima veniam" placeholder="Enter Details">
											</div>											
										</div>
										<div class="col-lg-12">
											<div class="form-group">
												<label>Status</label>
												<input type="text" class="form-control" value="Completed" placeholder="Enter Status">
											</div>											
										</div>
									</div>
								</div>							
