				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a class="active" href="faq.html"><i class="fe fe-alert-circle"></i> <span>FAQ</span></a>
							</li>
						</ul>
						<!-- /Content (CMS) -->
									...
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
											...
											<tbody>
												<tr>
													<td>1</td>
													<td>Duis aute irure in reprehenderit in voluptate velit?</td>
													<td>19 Dec 2022, 06:12 PM</td>
													<td>Ut enim ad minima veniam, quis nostrum exercitationem </td>
													<td class="d-flex align-items-center">
														<a class="btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_faq"><i class="fe fe-edit"></i></a>
												...
												<tr>
													...
													<td>Duis aute irure in reprehenderit in voluptate velit?</td>
													<td>19 Dec 2022, 06:12 PM</td>
													<td>At vero eos et accusamus et iusto odio dignissimos </td>
													<td class="d-flex align-items-center">
														<a class="btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_faq"><i class="fe fe-edit"></i></a>
														<a class="btn-action-icon" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="fe fe-trash-2"></i></a>
													</td>
												...
												<tr>
													<td>3</td>
													<td>Excepteur occaecat cupidatat non proident?</td>
													<td>19 Dec 2022, 06:12 PM</td>
													<td>Nam libero tempore, cum soluta nobis est eligendi optio </td>
													<td class="d-flex align-items-center">
														<a class="btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_faq"><i class="fe fe-edit"></i></a>
														<a class="btn-action-icon" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="fe fe-trash-2"></i></a>
													</td>
												...
												<tr>
													<td>5</td>
													<td>Nemo enim ipsam voluptatem quia voluptas sit?</td>
													<td>12 Dec 2022, 06:12 PM</td>
												...
												<tr>
													<td>6</td>
													<td>Neque porro quisquam est, qui dolorem ipsum?</td>
													<td>19 Dec 2022, 06:12 PM</td>
													<td>Temporibus autem quibusdam et officiis debitis aut rerum</td>
													<td class="d-flex align-items-center">
														<a class="btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_faq"><i class="fe fe-edit"></i></a>
														<a class="btn-action-icon" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="fe fe-trash-2"></i></a>
													</td>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Name</label>
										<input type="text" class="form-control" value="Duis aute irure in reprehenderit in voluptate velit?" placeholder="Enter Name">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Date</label>
										<input type="text" class="form-control" value="19 Dec 2022" placeholder="Select Date">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Category</label>
										<input type="text" class="form-control" value="Lorem ipsum dolor sit amet" placeholder="Category">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Details</label>
										<input type="text" class="form-control" value="Lorem ipsum dolor sit amet" placeholder="Details">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group mb-0">
										<label>Status</label>
										<input type="text" class="form-control" value="Success" placeholder="Status">
									</div>
								</div>
							</div>
						</div>
