						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a class="active" href="cities.html">Cities</a></li>
								</ul>
							</li>
							<li>
						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_cities"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add City</a>
									</li>
								</ul>
							</div>
						</div>
											...
											<tbody>
												<tr>
													...
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_cities"><i class="fe fe-edit"></i></a>
				...
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="#" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Add Cities</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Country Name</label>
										<input type="text" class="form-control" value="American Samoa" placeholder="Enter Name">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>State Name</label>
										<input type="text" class="form-control" value="Swains Island" placeholder="Select Date">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group mb-0">
										<label>City Name</label>
										<input type="text" class="form-control" value="Gandzasar" placeholder="Enter Reference Number">
									</div>
								</div>
							</div>
						</div>
