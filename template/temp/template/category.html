										...
										<table class="table table-center table-hover datatable">
											...
											<tbody>
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/category-01.jpg" alt="User Image">
														</h2>
													</td>
													<td>60</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/category-02.jpg" alt="User Image">
														</h2>
													</td>
													<td>55</td>
													<td class="d-flex align-items-center">
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/category-03.jpg" alt="User Image">
														</h2>
													</td>
													<td>70</td>
													<td class="d-flex align-items-center">
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/category-04.jpg" alt="User Image">
														</h2>
													</td>
													<td>82</td>
													<td class="d-flex align-items-center">
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/category-05.jpg" alt="User Image">
														</h2>
													</td>
													<td>26</td>
													<td class="d-flex align-items-center">
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<img class="avatar-img rounded" width="30" height="30" src="assets/img/category/category-06.jpg" alt="User Image">
														</h2>
													</td>
													<td>60</td>
													<td class="d-flex align-items-center">
				...
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="#" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Add Category</a>
						</div>
					</div>
				</div>
			</div>
