						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-delivery-challans.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create Delivery Challan</a>
									</li>
								</ul>
							</div>
						</div>
													...
													<td class="text-start">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<ul>
																	<li>
																		<a class="dropdown-item" href="edit-delivery-challans.html"><i class="far fa-edit me-2"></i>Edit</a>
																	</li>
																	<li>
