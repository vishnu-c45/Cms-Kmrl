							...
							<div class="row align-items-center">
								<div class="col-lg-12">
									<div class="invoices-tabs">
										<ul>
											<li><a href="tickets.html">All</a></li>
											...
											<li><a href="tickets-recurring.html" class="active">Recurring</a></li>
										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>
													...
													<td><span class="badge bg-primary-light">Recurring</span></td>
												...
												<tr>
													<td>
														<a href="invoice-details.html" class="invoice-link">#4995</a>
													</td>
													<td>Calling for help</td>
													<td>
														<h2 class="table-avatar">
