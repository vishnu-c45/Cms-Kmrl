				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a class="active" href="vendors.html"><i class="fe fe-user"></i> <span>Vendors</span></a>
							</li>
						</ul>
						<!-- /Customers -->
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#add_ledger"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create Ledger</a>
									</li>
								</ul>
							</div>
						</div>
										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>														
													...
													<td><span class="text-success-light">Credit</span></td>
													<td class="text-start">
												...
												<tr>
													...
													<td>#25689826</td>	
													<td>19 Dec 2022, 06:12 PM</td>													
													<td><span class="text-danger-light">Debit</span></td>
													<td class="text-start">
														<div class="dropdown dropdown-action">
															<a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
															<div class="dropdown-menu dropdown-menu-right">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Sharonda <span>+1 956-623-2881</span></a>
														</h2>
													</td>																										
													<td>#25689828</td>
													<td>19 Dec 2022, 06:12 PM</td>
												...
												<tr>														
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Randall <span>+1 956-623-2882</span></a>
														</h2>
													</td>											
													<td>#25689829</td>													
													<td>19 Dec 2022, 06:12 PM</td>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Pricilla <span>+1 956-623-2883</span></a>
														</h2>
													</td>																										
													<td>#25689830</td>												
													<td>19 Dec 2022, 06:12 PM</td>
												...
												<tr>														
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-07.jpg" alt="User Image"></a>
															<a href="profile.html">Johnny <span>+1 956-623-2884</span></a>
														</h2>
													</td>														
													<td>#25689831</td>														
													<td>19 Dec 2022, 06:12 PM</td>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Robert  <span>+1 956-623-2885</span></a>
														</h2>
													</td>																									
													<td>#25689832</td>	
													<td>19 Dec 2022, 06:12 PM</td>													
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Pricilla  Smith <span>+1 956-623-2886</span></a>
														</h2>
													</td>																										
													<td>#25689833</td>
													<td>19 Dec 2022, 06:12 PM</td>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="form-group d-inline-flex align-center mb-0">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="form-group mb-0">
										<label>Mode</label>
										<input type="text" class="form-control" value="Credit" placeholder="Enter Reference Number">
									</div>
								</div>
							</div>
						</div>
