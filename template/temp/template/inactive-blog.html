					...
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									<li><a class="active" href="all-blogs.html">All Blogs</a></li>
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-blog.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add BLog</a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="row align-items-center">
								<div class="col-lg-12">
									<div class="invoices-tabs">
										<ul>
											<li><a href="all-blogs.html">Active Blog</a></li>
											<li><a href="inactive-blog.html" class="active">Inactive Blog</a></li>	
										</ul>
									</div>
								</div>
							</div>
								...
								<div class="blog-content">
									...
									<div class="edit-options">
										<div class= "edit-delete-btn">
											<a href="#" class="text-muted"><i class="fe fe-edit me-1"></i> Edit</a>
											<a href="#" class="text-muted" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="fe fe-trash-2 me-1"></i> Delete</a>
										</div>
										<div class="text-end inactive-style">
											<a href="javascript:void(0);" class="text-muted" data-bs-toggle="modal" data-bs-target="#deleteNotConfirmModal"><i class="fe fe-alert-circle me-1"></i> Active</a>
										</div>
									</div>
								</div>
							</div>										
