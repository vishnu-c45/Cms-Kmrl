				...
				<div class="inv-content">
					...
					<div class="invoice-table-footer">
						<div class="table-footer-left notes">
							...
							<div class="delivery-notes">Delivery dates are not guaranteed and Seller has no liability
								for damages that may be incurred due to any delay.</div>
					...
					<div class="total-amountdetails">
						<p>Total amount ( in words): <span>$ One Thousand Eight Hundred Fifteen Only.</span>
						</p>
					</div>
