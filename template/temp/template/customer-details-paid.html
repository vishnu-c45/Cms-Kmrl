				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a class="active" href="customer-details.html"><i class="fe fe-file"></i> <span>Customer Details</span></a>
							</li>
							<li>
														...
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-end">
																<ul>
																	...
																	<li>
																		<a class="dropdown-item" href="customer-details-paid.html"><i class="far fa-bell me-2"></i>Active</a>
																	</li>
																	<li>
																		<a class="dropdown-item" href="customer-details-cancel.html"><i class="far fa-bell-slash me-2"></i>In Active</a>
																	</li>
																</ul>
															</div>
														</div>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Randall <span>+1 989-438-3131</span></a>
														</h2>
													</td>
													<td>$5,54,220</td>
													<td>$6,50,000</td>													
