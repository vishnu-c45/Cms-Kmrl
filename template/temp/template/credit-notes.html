						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-credit-notes.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Credit Notes</a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="row align-items-center">
								<div class="col-lg-12">
									<div class="invoices-tabs">
										<ul>
											<li><a href="credit-notes.html" class="active">All</a></li>
											<li><a href="credit-notes-pending.html">Pending</a></li>	
											<li><a href="credit-notes-overdue.html">Overdue</a></li>		
											<li><a href="credit-notes-draft.html">Draft</a></li>	
											<li><a href="credit-notes-recurring.html">Recurring</a></li>
											<li><a href="credit-notes-cancelled.html">Cancelled</a></li>
										</ul>
									</div>
								</div>
							</div>
										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>
													<td>1</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4987</a>
													</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
													...
													<td class="d-flex align-items-center">
														...
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<ul>
																	<li>
																		<a class="dropdown-item" href="edit-credit-notes.html"><i class="far fa-edit me-2"></i>Edit</a>
																	</li>
																	<li>
																	...
																	<li>
																		<a class="dropdown-item" href="credit-notes-details.html"><i class="far fa-eye me-2"></i>View</a>
																	</li>
																</ul>
															</div>
														</div>
												...
												<tr>
													<td>2</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4988</a>
													</td>
													<td>
														<h2 class="table-avatar">
												...
												<tr>
													<td>3</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4989</a>
													</td>
													<td>
														<h2 class="table-avatar">
													...
													<td>Cash</td>
													<td>23 Mar 2023</td>
													<td><span class="badge bg-light-gray text-gray-light">Overdue</span></td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" download><i class="fe fe-download"></i></a> 
														<div class="dropdown dropdown-action">
															<a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
												...
												<tr>
													<td>4</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4990</a>
													</td>
													<td>
														<h2 class="table-avatar">
												...
												<tr>
													<td>5</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4991</a>
													</td>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Russell Copeland<span>russell@example.com</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
												...
												<tr>
													<td>6</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4992</a>
													</td>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Barbara Moore<span>barbara@example.com</span></a>
														</h2>
													</td>
													<td>$1,54,220</td>													
													<td>Cash</td>
												...
												<tr>
													<td>7</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4993</a>
													</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
												...
												<tr>
													<td>8</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4994</a>
													</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-02.jpg" alt="User Image"></a>
												...
												<tr>
													<td>9</td>	
													<td>
														<a href="credit-notes-details.html" class="invoice-link">#4995</a>
													</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-03.jpg" alt="User Image"></a>
