				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a class="active" href="testimonials.html"><i class="fe fe-message-square"></i> <span>Testimonials</span></a>
							</li>
							<li>
						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-testimonials.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Testimonials</a>
									</li>
								</ul>
							</div>
						</div>
											...
											<tbody>
												<tr>
													...
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="edit-testimonials.html"><i class="fe fe-edit"></i></a>
