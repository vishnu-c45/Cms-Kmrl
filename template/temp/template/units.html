						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a class="active" href="units.html">Units</a></li>
								</ul>
							</li>
							<li>
											...
											<tbody>
												<tr>
													...
													<td class="d-flex align-items-center">
														<a class="btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_unit"><i class="fe fe-edit"></i></a>
				...
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="#" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Add Unit</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12 col-sm-12">
									<div class="form-group">
										<label>Name </label>
										<input type="text" class="form-control" value="Kilogram" placeholder="Enter Title">
									</div>
								</div>
								<div class="col-lg-12 col-sm-12">
									<div class="form-group">
										<label>Symbol</label>
										<input type="text" class="form-control" value="Slug" placeholder="Enter Slug">
									</div>
								</div>
								<div class="col-lg-12 col-sm-12">
									<div class="form-group mb-0">
