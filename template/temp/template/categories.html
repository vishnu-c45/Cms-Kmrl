						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-categories.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Categories</a>
									</li>
								</ul>
							</div>
						</div>
										...
										<table class="table table-stripped table-hover datatable">
											...
											<tbody>
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/category/category-01.jpg" alt="User Image">
														</h2>Advertising
													</td>
													<td>25 Fb 2022, 06:12 PM</td>
													<td>
													...
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" download=""><i class="fe fe-edit"></i></a>
														<a class=" btn-action-icon" href="javascript:void(0);" download=""><i class="fe fe-trash-2"></i></a>
													</td>
												</tr>
												<tr>
													<td>2</td>
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/category/category-02.jpg" alt="User Image">
														</h2>Food
													</td>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/category/category-03.jpg" alt="User Image">
														</h2>Marketing
													</td>
													<td>21 Dec 2022, 06:12 PM</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
															<a href="profile.html">Admin</a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/category/category-04.jpg" alt="User Image">
														</h2>Repairs
													</td>
													<td>30 Jan 2022, 06:12 PM</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
															<a href="profile.html">Admin</a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/category/category-05.jpg" alt="User Image">
														</h2>Software
													</td>
													<td>19 Mar 2022, 06:12 PM</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
															<a href="profile.html">Admin</a>
												...
												<tr>
													...
													<td>
														<h2>
															<img class="avatar-img rounded me-2" width="30" height="30" src="assets/img/category/category-06.jpg" alt="User Image">
														</h2>Stationary
													</td>
													<td>19 Jan 2022, 06:12 PM</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"></a>
															<a href="profile.html">Admin</a>
												...
												<tr>
													...
													<td>
                                                        <div class="status-toggle">
                                                            ...
                                                            <label for="rating_8" class="checktoggle checkbox-bg">checkbox</label>
                                                        </div>
                                                    </td>
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" download=""><i class="fe fe-edit"></i></a>
