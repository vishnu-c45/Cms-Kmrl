						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a class="active" href="states.html">States</a></li>
											...
											<tbody>
												<tr>
													...
													<td class="d-flex align-items-center">
														<a class=" btn-action-icon me-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_state"><i class="fe fe-edit"></i></a>
				...
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="#" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Add State</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Country Code</label>
										<input type="text" class="form-control" value="As" placeholder="Enter Country Code">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<label>Country Name</label>
										<input type="text" class="form-control" value="American Samoa" placeholder="Enter Country Name">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group mb-0">
										<label>State Name</label>
										<input type="text" class="form-control" value="Swains Island" placeholder="Enter State Name">
									</div>
								</div>
							</div>
						</div>
