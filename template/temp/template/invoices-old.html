						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-blog.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>New Customers</a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="card inovices-card">
								<div class="card-body">
									...
									<div class="d-flex justify-content-between align-items-center">
										<p class="inovices-all">No of Invoice <span class="rounded-circle bg-success-light ">02</span></p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card inovices-card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Total Outstanding</div>
											<div class="dash-counts">
												<p>$325,215</p>
											</div>
										</div>
									...
									<div class="d-flex justify-content-between align-items-center">
										<p class="inovices-all">No of Invoice <span class="rounded-circle bg-success-light ">03</span></p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-2 col-lg-4 col-sm-6 col-12">
							<div class="card inovices-card">
								<div class="card-body">
									...
									<div class="d-flex justify-content-between align-items-center">
										<p class="inovices-all">No of Invoice <span class="rounded-circle bg-success-light ">01</span></p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-2 col-lg-4 col-sm-6 col-12">
							<div class="card inovices-card">
								<div class="card-body">
									...
									<div class="d-flex justify-content-between align-items-center">
										<p class="inovices-all">No of Invoice <span class="rounded-circle bg-success-light ">04</span></p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-2 col-lg-4 col-sm-6 col-12">
							<div class="card inovices-card">
								<div class="card-body">
									...
									<div class="d-flex justify-content-between align-items-center">
										<p class="inovices-all">No of Invoice <span class="rounded-circle bg-success-light ">06</span></p>
									</div>
								</div>
							</div>
						</div>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Sharonda <span>sharonda@example.com</span></a>
														</h2>
													</td>
													<td>$2,54,220</td>	
													<td>12 May 2023</td>
