						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="add-user.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add user</a>
									</li>
								</ul>
							</div>
						</div>
										...
										<table class="table table-center table-hover datatable">
											...
											<tbody>
												<tr>
													...
													<td>$4,220</td>
													<td><span class="badge badge-pill bg-ash-gray text-gray-light">10 mins ago</span></td>
												...
												<tr>
													...
													<td><span class="badge badge-pill bg-ash-gray text-gray-light">Restricted</span></td>
													<td class="d-flex align-items-center">
														<div class="dropdown dropdown-action">
															<a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
															<div class="dropdown-menu dropdown-menu-right">
												...
												<tr>
													...
													<td>$6,789</td>
													<td><span class="badge badge-pill bg-ash-gray text-gray-light">1 hour ago</span></td>
												...
												<tr>
													...
													<td>$1,789</td>
													<td><span class="badge badge-pill bg-ash-gray text-gray-light">2 days ago</span></td>
													<td>04 Dec 2022, 12:38 PM</td>
													<td><span class="badge badge-pill bg-ash-gray text-gray-light">Restricted</span></td>
													<td class="d-flex align-items-center">
														<div class="dropdown dropdown-action">
