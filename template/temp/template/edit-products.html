				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								<a href="#" class="active"><i class="fe fe-package"></i> <span> Products / Services</span> <span class="menu-arrow"></span></a>
								<ul>
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="Product" placeholder="Enter Item Name">
											</div>	
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Name</label>
												<input type="text" class="form-control" value="Lorem ipsum dolor sit" placeholder="Enter Item Name">
											</div>											
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Item Category</label>
												<input type="text" class="form-control" value="Duis aute irure" placeholder="Enter Category Name">
											</div>											
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Price</label>
												<input type="number" class="form-control" value="253.00" placeholder="Enter Item Price" name="name">
											</div>
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Units</label>
												<input type="text" class="form-control" value="Inches" placeholder="Enter Units" name="name">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										<div class="col-xl-3 col-lg-4 col-md-6 col-12"> 
											<div class="form-group">
												...
												<input type="text" class="form-control" value="P125389" placeholder="Enter Barcode Number">
											</div>
										</div>
										<div class="col-xl-3 col-lg-4 col-md-6 col-12"> 
											<div class="form-group">
												<label>Purchase Price Without Tax</label>
												<input type="text" class="form-control" value="$00.00" placeholder="Enter Address 1">
											</div>
										</div>
										<div class="col-xl-3 col-lg-4 col-md-6 col-12"> 
											<div class="form-group">
												<label>Purchase Price With Tax</label>
												<input type="text" class="form-control" value="$253.00" placeholder="Enter Tax Amount">
											</div>
										</div>
										<div class="col-xl-3 col-lg-4 col-md-6 col-12"> 
											<div class="form-group">
												<label>Quantity</label>
												<input type="text" class="form-control" value="2" placeholder="eg 10">
											</div>
										</div>
										<div class="col-xl-6 col-lg-6 col-md-6 col-12"> 
											<div class="form-group" id="summernote_container">
												<label class="form-control-label">Details</label>
												<textarea class="summernote form-control" placeholder="Lorem ipsum dolor sit"></textarea>
											</div>
										</div>
										<div class="col-xl-6 col-lg-6 col-md-6 col-12"> 
											<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="$10.00" placeholder="Enter Discount Amount">
											</div>										
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
