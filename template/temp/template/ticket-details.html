						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a class="active" href="ticket-details.html">Ticket Overview</a></li>
								</ul>
							</li>
						</ul>
						<!-- /Support -->
						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									<li>
										<a class="btn btn-primary popup-toggle rounded-circle d-inline-flex p-2" href="javascript:void(0);"><i class="fe fe-filter" aria-hidden="true"></i></a>
									</li>
								</ul>
							</div>
						</div>
								...
								<div class="customer-details">
									<div class="d-flex align-items-center">
										<span class="customer-widget-img d-inline-flex">
											<img class="rounded-circle" src="assets/img/profiles/avatar-05.jpg" alt="">
										</span>
							...
							<div class="col-lg-6 col-md-12">
								...
								<div class="card-inform d-block mt-lg-5 mt-0">
									<ul class="activity-feed">
										<li class="feed-item">
											<span class="feed-text"><strong class="text-gray-dark me-2">John Smith</strong> Created a new response Created a new response</span>
											<p>30 Dec 2022 01:24AM</p>
										</li>
										<li class="feed-item">
											<span class="feed-text"><strong class="text-gray-dark me-2">Forest Kroch </strong> Lorem ipsum dolor sit amet,</span>
											<p>24 Dec 2022 10:36AM</p>
										</li>
										<li class="feed-item">
											<span class="feed-text"><strong class="text-gray-dark me-2">Townsend Seary </strong> Sed ut perspiciatis unde</span>
											<p>18 Dec 2022 09:18PM</p>
										</li>
										<li class="feed-item">
											<span class="feed-text"><strong class="text-gray-dark me-2">Margaretta Worvell </strong> Nemo enim ipsam voluptatem</span>
											<p>19 Jan 2022 09:18PM</p>
										</li>
										<li class="feed-item">
											<span class="feed-text"><strong class="text-gray-dark me-2">Harald Kowalski </strong> Neque porro quisquam est, qui dolorem</span>
						...
						<div class="card">
							<div class="card-body">
								<div class="comments-details d-flex align-items-center justify-content-between">
									...
									<a href="#" class="reply-comment d-flex"><span><i class="fe fe-corner-down-left me-2"></i></span>Reply</a>
								</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<ul class="dropdown-menu action-drop">
												<li>
													<a href="#" class="dropdown-item"><i class="fa-solid fa-circle info-border me-2 text-info"></i> High</a>
												</li>
												<li>
													<a href="#" class="dropdown-item"><i class="fa-solid fa-circle warning-border me-2 text-warning-light"></i> Medium</a>
												</li>
												<li>
													<a href="#" class="dropdown-item"><i class="fa-solid fa-circle danger-border me-2 text-danger-light"></i> Low</a>
												</li>
											</ul>
										</div>
									</div>
