								...
								<div class="card-body">
									<div class="form-group-item">
										...
										<div class="row">
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="form-group">
													<label>Phone</label>
													<input type="text" id="mobile_code" class="form-control" value="+1 989-438-3131" placeholder="Phone Number" name="name">
												</div>
											</div>
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="form-group">
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="form-group">
													<label>Notes</label>
													<input type="email" class="form-control" value="Lorem Ipsum is simply dummy" placeholder="Enter Your Notes">
												</div>											
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" value="4581 Sunny Glen Lane" placeholder="Enter Address 1">
												</div>
												<div class="form-group">
													<label>Address Line 2</label>
													<input type="text" class="form-control" value="Cleveland, OH 44106" placeholder="Enter Address 1">
												</div>
												<div class="row">
													<div class="col-lg-6 col-md-12">
														<div class="form-group">
															<label>Country</label>
															<input type="text" class="form-control" value="Australia" placeholder="Country">
														</div>
														<div class="form-group">
															<label>City</label>
															<input type="text" class="form-control" value="Melbourne" placeholder="City">
														</div>
													</div>
													<div class="col-lg-6 col-md-12">
														<div class="form-group">
															<label>State</label>
															<input type="text" class="form-control" value="Victoria" placeholder="State">
														</div>
														<div class="form-group">
														<label>Pincode</label>
															<input type="text" class="form-control" value="3000" placeholder="Pincode">
														</div>
													</div>
												</div>
											</div>
									...
									<div class="form-group-customer customer-additional-form">
										<div class="row">
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="form-group">
													<h5 class="form-title">Additional Details <span class="optional">(Optional)</span></h5>
												</div>
												<div class="form-group">
													<label>Discount <span class="optional">(%)</span></label>
													<input type="text" class="form-control" value="1" placeholder="Enter Discount">
												</div>
												<div class="form-group notes-form-group">
													<label>Notes</label>
													<textarea class="form-control" placeholder="Enter Your Description">Lorem Ipsum is simply dummy</textarea>
												</div>
												<div class="form-group">
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="form-group">
													<h5 class="form-title">Company Details <span class="optional">(Optional)</span></h5>
												</div>
												<div class="form-group">
													<label>Company Name</label>
													<input type="text" class="form-control" value="Kanakku" placeholder="Enter Company Name">
												</div>
												<div class="form-group">
													<label>GST No</label>
													<input type="text" class="form-control" value="123456" placeholder="Enter GST Nuber">
												</div>											
											</div>
											<div class="col-lg-4 col-md-12 col-sm-12">
												<div class="form-group">												
													<h5 class="form-title">Opening Balance <span class="optional">(Optional)</span></h5>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" value="$200" placeholder="Enter Debit Amount">
												</div>
												<div class="form-group">
													<label>Balance</label>
													<input type="text" class="form-control bg-blue-light border-0" placeholder="$ 100">
												</div>
											</div>
										</div>
									</div>								
