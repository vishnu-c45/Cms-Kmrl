				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a class="active" href="roles-permission.html"><i class="fe fe-clipboard"></i> <span>Roles & Permission</span></a>
							</li>
							<li>
				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						...
						<div class="role-testing d-flex align-items-center justify-content-between">
							...
							<p><label class="custom_check"><input type="checkbox" name="invoice"><span class="checkmark"></span></label>Allow All Modules</p>
						</div>
					</div>
					<!-- /Page Header -->
