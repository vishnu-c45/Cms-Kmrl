								...
								<ul class="notification-list">
									...
									<li class="notification-message">
										<a href="profile.html">
											<div class="media d-flex">
												<div class="avatar avatar-sm">
													<span class="avatar-title rounded-circle"><i class="far fa-comment"></i></span>
												</div>
												<div class="media-body">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									<li><a class="active" href="membership-plans.html">Membership Plans</a></li>
						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									<li>
										<a class="btn btn-primary" href="add-membership.html"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Membership</a>
									</li>
								</ul>
							</div>
						</div>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="plan-button">
											<a class="btn btn-primary d-flex align-items-center justify-content-center" href="#">Get Started<span class="ms-2"><i class="fe fe-arrow-right"></i></span></a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-12">
								<div class="card price-selected">
									<div class="card-body plan-header-selected">
										...
										<div class="price-dollar">
											<h1 class="d-flex align-items-center text-white">$199<span class="text-white ms-1">/monthly</span></h1>
										</div>	
										<div class="plan-description">
											<h6 class="text-white">What’s included</h6>
											<ul>
												<li>
													<span class="rounded-circle bg-white me-2"><i class="text-primary fe fe-check"></i></span>
													All analytics features
												</li>
												<li>
													<span class="rounded-circle bg-white me-2"><i class="text-primary fe fe-check"></i></span>
										...
										<div class="plan-button">
											<a class="btn btn-white d-flex align-items-center justify-content-center" href="#">Get Started<span class="ms-2"><i class="fe fe-arrow-right"></i></span></a>
										</div>	
									</div>
								</div>
							</div>	
