										...
										<div class="row align-item-center">
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Enter Delivery Challan Number">
												</div>
											</div>										
											<div class="col-lg-4 col-md-6 col-sm-12">											
												<div class="form-group">
											...
											<div class="form-group-bank">
												<div class="form-group">
													...
													<div class="bank-details">													
														<a class="text-danger-light" href="#" data-bs-toggle="modal" data-bs-target="#bank_details"><i class="fas fa-bank me-2"></i>Add Bank Details</a>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-4 col-md-12">
														<div class="form-group">
															...
															<input type="text" class="bg-white-smoke form-control" placeholder="13.2">
														</div>
													</div>
												</div>
