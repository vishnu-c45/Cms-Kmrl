										...
										<table class="table table-center table-hover datatable">
											...
											<tbody>
													...
													<td class="d-flex align-items-center">
														...
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<ul>
																	<li>
																		<a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_inventory"><i class="far fa-edit me-2"></i>Edit</a>
																	</li>
																	<li>
												...
												<tr>
													...
													<td>$700.00</td>
													<td class="d-flex align-items-center">
														<a href="#" class="btn btn-greys bg-success-light me-2" data-bs-toggle="modal" data-bs-target="#stock_int">
															<i class="fa fa-plus-circle me-1"></i> Stock in
														</a> 
														<a href="#" class="btn btn-greys bg-danger-light me-2" data-bs-toggle="modal" data-bs-target="#stock_out">
															<i class="fa fa-plus-circle me-1"></i> Stock out
