									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text"  class="form-control mb-2" placeholder="Enter Title">
												<span class="optional">(If you leave it empty, it will be generated automatically.)</span>
											</div>											
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Description (Meta Tag) <span class="star-red">*</span></label>
												<input type="text" data-role="tagsinput" class="input-tags form-control" placeholder="" name="services" value="Description Tag" id="services">
											</div>
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<label>Keywords (Meta Tag) <span class="star-red">*</span></label>
												<input type="text" data-role="tagsinput" class="input-tags form-control" placeholder="" name="services" value="Keywords Tag" id="services2">
											</div>
										</div>
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
