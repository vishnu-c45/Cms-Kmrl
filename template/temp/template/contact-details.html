...
<html lang="en">
	...
	<body>
		...
		<div class="main-wrapper">
					...
					<ul class="contact-details">
						<li>
							<div class="d-flex align-items-center">
								<span class="me-3"><img class="rounded-circle" width="38" height="38" src="assets/img/profiles/avatar-02.jpg" alt="User Image"></span>
								<div>
									<p>John Smith </p>
						...
						<li>
							<a href="#" class="float-xl-end float-lg-start btn btn-primary" data-bs-toggle="modal" data-bs-target="#contact_reply">Reply</a>
						</li>
					</ul>
					<!-- /Page Header -->
			...
			<!-- Modal -->
			<div class="modal custom-modal fade" id="contact_reply" role="dialog">
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						<div class="modal-header border-0 pb-0">
							<div class="form-header modal-header-title text-start mb-0">
								<h4 class="mb-0">Reply Contact</h4>
							</div>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group mb-0" id = "summernote_container">
